...
# download file 'all_players_profile_links_CSV' and copy/paste the path
...
for player_link in csv_data:
  ...
  # this extract team name and save as text in 'team_name'
  ...
  # this tag has name of player not the full name
  # because we have names in other csv table also and want to match this name with other table
  ...
  # image link is loaded dynamically so using Selenium to scrap the image_link
  # from selenium.webdriver import Chrome
  # from selenium.webdriver.chrome.options import Options
